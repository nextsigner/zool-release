...
Item{
    ...
    property var cAs: r
    property int planetSize: 100//sweg.fs*0.75
    ...
    Repeater{
        ...
        ZoolAsBack{astro:modelData;numAstro: index}
    }
...
//            }
            ...
            if(app.mod!=='dirprim'){
                ...
                o.ih=sweg.objHousesCircleBack.getHousePos(o.gdec, intJson.ph.h1.gdec, i, jo.ih)
                if(i===9){
                    //log.lv('sweg.dirPrimRot:'+sweg.dirPrimRot)
                    //log.lv('o.is:'+o.is)
                ...
                let nDMS=sweg.getDDToDMS(o.gdec)
