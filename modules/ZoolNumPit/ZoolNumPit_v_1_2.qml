...
//        if(txtDataSearchFirma.text==='' || txtDataSearchFirma.text===' ' || txtDataSearchFirma.text==='  '){
//            return -1
//        }
        let vtv=0
    ...
    function getTodo(formula){
        ...
        if(getItemJson('firma'+r.currentNumFirma)){
            ...
            ret+='¿Cómo es la energía de su firma?\n\n'
            ret+='No se ha podido calcular la energía de su firma. Probablemente no se ha especificado cuál es la firma.\n\n'
        }
