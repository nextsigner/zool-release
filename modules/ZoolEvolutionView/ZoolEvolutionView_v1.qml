...
Rectangle{
    ...
    Component{
        ...
        Rectangle{
            ...
            Component.onCompleted: {
                if(xIcon.i===8){
                    r.icon8=xIcon//r.wdeg*360
                }
                if(xIcon.i===16){
                    r.icon16=xIcon//r.wdeg*360
                }
            }
        }
    }
    Component.onCompleted: {
        ...
        let icon1 = compIconEv.createObject(rowIcons, {i: 1, s: 2.0})
        let icon8 = compIconEv.createObject(xSigns, {i: 8, s: 1.0})
        let icon16 = compIconEv.createObject(xSigns, {i: 16, s: 1.0})
