...
Item{
    ...
    Rectangle {
        ...
        height: width
        anchors.centerIn: parent
        color: "transparent" // Color transparente para que la máscara funcione correctamente
        ...
        OpacityMask {
           anchors.fill: parent
            source: Rectangle {
                ...
                Rectangle {
                    width: parent.width * 0.5 // Ancho del rectángulo interior vacío
                    height: parent.height * 0.5 // Alto del rectángulo interior vacío
                    anchors.centerIn: parent // Centra el rectángulo interior dentro del rectángulo exterior
                    color: "transparent" // Color transparente para que el rectángulo interior esté vacío
                    border.color: "red" // Color del borde del rectángulo interior (opcional)
                    border.width: 2 // Ancho del borde del rectángulo interior (opcional)
                }
            }
        }
    }
