...
//    }
    ...
    Component{
        ...
        Rectangle{
            ...
            property bool selected: r.isExt?(item.ih===zm.currentHouseIndex && zm.currentPlanetIndex<0):(item.ih===zm.currentHouseIndexBack && zm.currentPlanetIndexBack<0)//item.ih===r.currentHouse//false
            property int is: -1
